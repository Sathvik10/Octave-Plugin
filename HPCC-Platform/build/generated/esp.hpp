...
interface IEspServiceRequest : extends IInterface
{
	virtual unsigned long getClientIP() const = 0;
	virtual const char * getUserName() const = 0;
	virtual const char * getPasswordHash() const = 0;
};



interface IEspServiceResponse : extends IInterface
{
};
...
interface IEspUriMap : extends IInterface
{
	virtual void addBinding(const char * name, const char * host, unsigned short port, IEspService & service) = 0;
	virtual void addProtocol(const char * name, IEspProtocol & prot) = 0;
	virtual ISocketSelectNotify * getListener() = 0;
	virtual int run() = 0;
	virtual int stop() = 0;
};
...
interface IEspBindingCfg : extends IInterface
{
...
interface IEspQuickMonRequest : extends IEspServiceRequest
{
	virtual void tbd() const = 0;
};


interface IEspQuickMonResponse : extends IEspServiceResponse
{
	virtual void setStatus(QuickMonStatus status, const char * descr) = 0;
};


interface IEspQuickMonService : extends IEspService
{
	virtual bool onGetStatus(IEspQuickMonRequest & request, IEspQuickMonResponse & results) = 0;
};
...
interface IEspSimpleDataRequest : extends IInterface
{
	virtual const char * getPath() = 0;
	virtual const char * getService() = 0;
	virtual const char * getScrubbedXML() = 0;
	virtual bool getSaveWorkunit() = 0;
	virtual bool getLimitResults() = 0;
	virtual bool getIncludeGraph() = 0;
	virtual bool getIncludeResultSchemas() = 0;
	virtual bool getEncodeDataset() = 0;
	virtual MapStrToBuf * getDataAttachments() = 0;
	virtual const char * getClusterName() = 0;
	virtual int getWuTimeout() = 0;
	virtual bool getNoWuAbort() = 0;
	virtual bool getAsync() = 0;
	virtual bool getTrimXml() = 0;
	virtual bool getRawXml() = 0;
};


interface IEspSimpleDataResponse : extends IInterface
{
	virtual StringBuffer & updateResultsXML() = 0;
	virtual void setWorkunitId(const char * wuid) = 0;
	virtual void setMessageXML(const char * xml) = 0;
	virtual void setResultsXML(const char * xml) = 0;
	virtual void setEclWatchAddress(const char * addr) = 0;
	virtual void setAsync(bool isasync) = 0;
	virtual void addGraphXGMML(const char * xgmml, const char * graphname) = 0;
};


interface IEspSimpleDataRefResponse : extends IInterface
{
	virtual void setMessageXML(const char * xml) = 0;
	virtual void setResultsPath(const char * path) = 0;
};


interface IEspSimpleDataRetrievalRequest : extends IInterface
{
	virtual const char * getResultsPath() = 0;
};



interface IEspSimpleDataService : extends IEspService
{
	virtual bool getUseModName() = 0;
	virtual bool getUseModInWsdl() = 0;
	virtual bool encodeResultsXml() = 0;
	virtual int onSimpleDataRequest(IEspContext & context, IPropertyTree * partsTree, IEspSimpleDataRequest & req, IEspSimpleDataResponse & resp) = 0;
};


interface IEspSimpleDataRetrievalService : extends IEspService
{
	virtual int onSimpleDataByRefRequest(IEspContext & context, IEspSimpleDataRequest & req, IEspSimpleDataRefResponse & resp) = 0;
	virtual int onSimpleDataRetrieval(IEspContext & context, IEspSimpleDataRetrievalRequest & req, IEspSimpleDataResponse & resp) = 0;
};
...
interface IEspWebService : extends IInterface
{
	virtual bool isValidWsName(IEspContext & context, const char * servname) = 0;
	virtual bool qualifyWsName(IEspContext & context, const char * servname, const char * methname, StringBuffer & servQName, StringBuffer * methQName) = 0;
	virtual bool fixCase(IEspContext & context, StringBuffer & service, StringBuffer & method) = 0;
	virtual bool getWsModules(IEspContext & context, StringArray & wsModules, StringBuffer & mode) = 0;
	virtual bool getWsQueries(IEspContext & context, const char * path, bool aliasOnly, IPropertyTree * wsQueryInfo) = 0;
	virtual bool getWSDL(IEspContext & context, const char * path, const char * method, StringBuffer & wsdlMsg) = 0;
	virtual bool getWSDL_Message(IEspContext & context, const char * path, const char * method, StringBuffer & wsdlMsg) = 0;
	virtual bool getWSDL_Schema(IEspContext & context, const char * path, const char * method, StringBuffer & wsdlSchema) = 0;
	virtual bool getResults_Schema(IEspContext & context, const char * path, const char * method, StringBuffer & dataSchema) = 0;
	virtual const char * translateXsdType(const char * (null)) = 0;
	virtual bool getResultXsd(IEspContext & context, const char * service, const char * method, const char * resultName, StringBuffer & dataSchema) = 0;
};
...
interface IEspHtmlForm : extends IInterface
{
	virtual bool getHtmlForm(IEspContext & context, const char * path, const char * method, StringBuffer & formStr) = 0;
	virtual bool getMetaBlock(IEspContext & context, const char * name, const char * service, const char * method, StringBuffer & blockStr) = 0;
	virtual bool getParametersXml(IEspContext & context, const char * path, const char * method, StringBuffer & formStr) = 0;
	virtual bool getDescriptiveXml(IEspContext & context, const char * path, const char * method, StringBuffer & xmlStr) = 0;
	virtual bool getHtmlResults_Xslt(IEspContext & context, const char * path, const char * method, StringBuffer & xsltStr) = 0;
	virtual bool applyXslAttribute(IEspContext & context, const char * path, const char * method, const char * sectionName, const char * input, const char * fullPath, StringBuffer & ret, bool nodefault) = 0;
	virtual bool getOTX(IEspContext & context, const char * path, const char * method, StringBuffer & xmlStr) = 0;
	virtual bool getCacheInfo(IEspContext & context, const char * name, StringBuffer & blockStr) = 0;
};


interface IEspFileService : extends IInterface
{
	virtual bool getFile(IEspContext & context, const char * path, MemoryBuffer & data) = 0;
	virtual bool putFile(IEspContext & context, const char * path, void * data, unsigned len) = 0;
};
